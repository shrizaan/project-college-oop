/**
 * Fungsi class ini adalah sebagagi superclass
 * dari class CekSaldo, TarikTunai, SetorTunai, Transfer, dan GantiPIn.
 *
 ...
 *
 * Class ini memiliki modifier abstract yang berarti class Transaksi ini
 * tidak bisa digunakan untuk membuat object/
 *
 * Class ini juga memiliki method abstract yang berarti method tersebut harus di override di class turunannya.
 * Class ini juga meng-implements interface FormatUang yang berarti
 * class ini harus mengimplementasikan method formatUang.
 */

// digunakan untuk mengubah format angka menjadi format mata uang rupiah
...
public abstract class Transaksi implements FormatUang {
     ...
     * Supaya class Transaksi dan class turunannya bisa mengakses
     * attribute dari class AkunNasabah yang sedang login sekarang
     */
    ...
    public Transaksi(AkunNasabah objekAkunNasabah) {
        // mengisi attribute objekAkunNasabah dengan nilai dari parameter objekAkunNasabah
        // atau dengan kata lain mengambil object AkunNasabah yang sedang login sekarang
     ...
     * tetapi karena method ini memiliki modifier abstract
     * maka method ini harus di override di class turunannya.
     */
