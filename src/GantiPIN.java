 ...
 *
 * Class ini memiliki attribute pinLama dan pinBaru bertipe String yang
 * digunakan untuk menyimpan pin lama dan pin baru.
 *
...
public class GantiPIN extends Transaksi {
    ...
    public void prosesTransaksi() {
        ...
        System.out.print("\nMasukkan PIN lama: ");
        // mengambil input dari user dan menyimpannya ke dalam attribute pinLama
        ...
        if (pinLama.equals(objekAkunNasabah.pin)) {
             ...
             * Alasan dibuat terus menerurs karena ketika suatu user melakukan
             * input yang salah atau tidak cocok dengan kondisi.
            ...
            while (true) {
                ...
                // mengambil input dari user dan menyimpannya ke dalam attribute pinBaru
                ...
                if (pinBaru.equals(konfirmasiPinBaru)) {
                    ...
                    // menampilkan pesan bahwa pin berhasil diganti
